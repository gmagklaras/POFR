...
The latest production release of POFR is v1.2.1 named "Hedy Lamarr" (Oct 23, 2022). Previous versions are available from the [POFR Release Archive](https://github.com/gmagklaras/POFR/releases).  
